<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Home.Master" AutoEventWireup="true" CodeBehind="AddTeam.aspx.cs" Inherits="TaskManagementSystem.Admin.AddTeam" %>
               ...
               <div class="row">
                <div class="col-md-6 col-md-offset-3 input-container" id="form">                 
                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="TeamId"></asp:Label>
                        <asp:TextBox ID="txtteamid" runat="server" CssClass="txt"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label2" runat="server" Text="TeamName"></asp:Label>
                    ...
                    <div class="btn">
                        <asp:Button ID="Button1" runat="server" CssClass="btn-2" Text="Add" Font-Bold="true" ForeColor="Green" OnClick="Button1_Click"/>
                    </div>
                </div>
            </div>
            </section>
